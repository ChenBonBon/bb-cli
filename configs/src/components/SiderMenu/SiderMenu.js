...
const getIcon = (icon) => {
	...
	if (typeof icon === 'string') {
		if (icon.startsWith('bb-')) {
			return <BBIcon type={icon.substr(3)} className={styles.bbIcon} />;
		}
	...
	render() {
		...
		return (
			...
			>
				...
				{collapsed && <BBIcon className={styles.trigger} type="menu-unfold" onClick={this.toggle} />}
